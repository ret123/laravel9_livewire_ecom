                ...
                <div class="carausel-6-columns-cover position-relative">
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        ...
                        <div class="card-1">
                            ...
                            <a href="{{route('product.category',$cat->slug)}}"><img src="{{asset('assets/imgs/categories')}}/{{$cat->image}}" alt=""></a>
                            </figure>
                        <h5><a href="{{route('product.category',$cat->slug)}}">{{$cat->name}}</a></h5>
                       </div>
                       @endforeach
                    </div>
                </div>
                            ...
                            <div class="product-cart-wrap small hover-up">
                                <div class="product-img-action-wrap">
                                    ...
                                    <a href="{{route('product.details',$product->slug)}}">
                                            <img class="default-img" src="{{asset('assets/imgs/products')}}/{{$product->image}}">
