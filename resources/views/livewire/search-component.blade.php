            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="active" href="#" wire:click="changePageSize(12)">12</a></li>
                                            <li><a href="#" wire:click="changePageSize(15)">15</a></li>
                                            <li><a href="#" wire:click="changePageSize(24)">24</a></li>
                                            <li><a href="#" wire:click="changePageSize(48)">48</a></li>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{$orderBy == 'DS' ? 'active' : ''}}"
                                                    wire:click.prevent="changeOrder('DS')" href="#">Default Sorting</a>
                                            </li>
                                            <li><a class="{{$orderBy == 'PLH' ? 'active' : ''}}"
                                                    wire:click.prevent="changeOrder('PLH')" href="#">Price: Low to
                                                    High</a></li>
                                            <li><a class="{{$orderBy == 'PHL' ? 'active' : ''}}"
                                                    wire:click.prevent="changeOrder('PHL')" href="#">Price: High to
                                                    Low</a></li>

                                            <li><a class="{{$orderBy == 'SBN' ? 'active' : ''}}"
                                                    wire:click.prevent="changeOrder('SBN')" href="#">Sort By Newness</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{route('product.details',$product->slug)}}">{{$product->name}}</a>
                                        </h2>
                        ...
                        <div class="mt-4 p-2 flex justify-center align-center">
                            <button wire:click="loadMore"
                                class="px-4 py-2 bg-orange-300 hover:bg-orange-500 text-white">Load More</button>
                        </div>
                        @endif
                        <div class="pagination-area mt-15 mb-sm-5 mb-lg-0">
                            <nav aria-label="Page navigation example flex-row">
                                {{ $products->links() }}
