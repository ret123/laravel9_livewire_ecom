                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="image product-thumbnail"><img
                                                src="{{asset('assets/imgs/products')}}/{{$product->image}}"                                                alt="#"></td>
                                        ...
                                        <td class="text-center" data-title="Stock">
                                            ...
                                            <a wire:click.prevent="decrease('{{$item->rowId}}')" href="#" class="qty-down"><i class="fi-rs-angle-small-down"></i></a>
                                                <span class="qty-val">{{$item->qty}}</span>
                                                <a wire:click.prevent="increase('{{$item->rowId}}')" href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                            </div>
                                        </td>
                                        <td class="text-right" data-title="Cart">
                                            <span>${{$item->subtotal}} </span>
                                        </td>
                                    <td class="action" data-title="Remove"><a href="#"      class="text-muted" wire:click.prevent="delete('{{$item->rowId}}')"><i class="fi-rs-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <a wire:click.prevent="clearCart()" href="#" class="text-muted"> <i class="fi-rs-cross-small"></i> Clear
                                                Cart</a>
                                        </td>
                                    </tr>
                                </tbody>
