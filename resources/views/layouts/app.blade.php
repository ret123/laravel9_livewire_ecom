                    ...
                    <div class="header-right">
                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                @livewire('wish-list-item-component')
                                {{--  Cart Item --}}
                                @livewire('cart-item-component')
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container pt-15 pb-20">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0 flex-column">
                            ...
                            <div class="flex wow fadeIn animated mb-sm-5 mb-md-0">
                               
                                       
                                    <a href="#"><img class="w-10 h-10" src="{{asset('assets/imgs/theme/icons/icon-facebook.svg')}}" alt=""></a>
                                    <a href="#"><img class="w-10 h-10" src="{{asset('assets/imgs/theme/icons/icon-twitter.svg')}}" alt=""></a>
                                    <a href="#"><img class="w-10 h-10" src="{{asset('assets/imgs/theme/icons/icon-instagram.svg')}}" alt=""></a>
                                    <a href="#"><img class="w-10 h-10" src="{{asset('assets/imgs/theme/icons/icon-pinterest.svg')}}" alt=""></a>
                                    <a href="#"><img class="w-10 h-10" src="{{asset('assets/imgs/theme/icons/icon-youtube.svg')}}" alt=""></a>
                                </div>
                        </div>
                    </div>
